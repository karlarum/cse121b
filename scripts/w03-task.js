...
function getTotalDue() {
    ...
    let discount = membershipCheckbox ? membershipCheckbox.checked : false;
...
document.querySelector('#sumOfMultiplied').innerHTML = numbersArray.map(number => number *2).reduce((total, number) => total + number);